...
export default class ParticleSystemObject extends SceneObject {
  ...
  updateBoundaryBox(width) {
    const currentBox = new Float32Array(6);
    ...
    // Write the updated boundary box to the GPU buffer
  ...
  resetParticles() {
    ...
    for (let i = 0; i < this._numParticles; ++i) {
      ...
      this._particles[10 * i + 2] = (Math.random() * 2 - 1) * 0.005;
      this._particles[10 * i + 3] = Math.random() * 0.01;
